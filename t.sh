...
# Menu
	echo ""
	echo -e "ฟังก์ชั่นสคริปท์ ${GRAY}มือใหม่*${NC}"
	echo ""
...
newclient () {
	...
	wget -O ~/EasyRSA-unix-v3.0.6.tgz "https://github.com/OpenVPN/easy-rsa/releases/download/v3.0.6/EasyRSA-unix-v3.0.6.tgz"
...
exit 0' > $RCLOCAL
	...
	if [[ "$IP" != "$EXTERNALIP" ]]; then
		...
		echo "NAT คืออะไร ? : http://www.greatinfonet.co.th/15396680/nat"
		echo ""
...
/etc/init.d/nginx restart
	...
	wget -O /usr/local/bin/menu "https://raw.githubusercontent.com/lowkbyzx/VPNTzAA/master/Menu"
